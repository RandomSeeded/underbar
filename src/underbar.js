...
/*    return n === undefined ? array[array.length-1] : array.slice(array.length-n, array.length);*/
  ...
  _.each = function(collection, iterator) {
    if (Array.isArray(collection)) {
      ...
      // NOTE: this will run on inherited properties for objects.
  ...
  _.reject = function(collection, test) {
    ...
    // The idea is we want to give filter the function which is the opposite / inverse of test
  ...
  _.every = function(collection, iterator) {
    ...
    // If no call-back provided, run boolean on the item directly
  ...
  _.delay = function(func, wait) {
    // NOTE: this should probably be refactored, there's probably a better way to do this
    var newArgs = [];
  ...
  _.shuffle = function(array) {
    ...
    while (arrCopy.length > 0) {
      shuffled.push(arrCopy.splice(Math.floor(Math.random()*arrCopy.length),1)[0]);
    }
    return shuffled;
  };
  ...
  _.invoke = function(collection, functionOrKey, args) {
    ...
    _.each(collection, function(element) {
      /*if (typeof functionOrKey === string) {
        //results.push(element[functionOrKey](arguments));
      }*/
      if (typeof functionOrKey === "string") { results.push(element[functionOrKey](arguments)); }
      else { results.push(functionOrKey.apply(element, arguments)); }
    });
    return results;
  };
